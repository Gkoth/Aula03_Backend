...
// let freqeuncia = 80; //em %
// let passouPorNota = media >= 7.0;
// let passouPorPresenca = freqeuncia >= 75;
// let alunoAprovado = passouPorNota && passouPorPresenca;
// console.log(`Media: ${media}| Aprovado: ${alunoAprovado}`);
...
app.listen(3000, () => {
    console.log('Servirço rodando http://localhost:3000/api/calculo-teste');
});